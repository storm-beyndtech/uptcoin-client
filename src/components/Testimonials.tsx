...
export default function Testimonials({ data }: { data: TestimonialsProp }) {
  ...
  return (
    <section>
      <div className="overflow-hidden bg-bodydark">
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="max-ctn mb-6 sm:mb-10">
          ...
          >
            {data.map((item, i) => (
              <SwiperSlide className="flex h-auto" key={i}>
                <div className="flex flex-col bg-bodydark2/30 rounded-xl">
                  ...
                  <div className="p-4 rounded-b-xl md:px-7 bg-bodydark2">
